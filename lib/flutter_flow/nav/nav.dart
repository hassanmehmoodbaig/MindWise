        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'moodCalender',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'MoodCalender')
                  : MoodCalenderWidget(),
            ),
            FFRoute(
              name: 'DiaryPage',

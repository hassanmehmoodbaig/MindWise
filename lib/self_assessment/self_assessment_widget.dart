...
export 'self_assessment_model.dart';

class SelfAssessmentWidget extends StatefulWidget {
  const SelfAssessmentWidget({Key? key}) : super(key: key);

  @override
  _SelfAssessmentWidgetState createState() => _SelfAssessmentWidgetState();
}

class _SelfAssessmentWidgetState extends State<SelfAssessmentWidget>
    with TickerProviderStateMixin {
  late SelfAssessmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelfAssessmentModel());
